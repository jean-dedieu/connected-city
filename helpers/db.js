...
export const init = () => {
  const promise = new Promise((resolve, reject) => {
     ...
     */
    db.transaction((tx) => {
        tx.executeSql('CREATE TABLE IF NOT EXISTS alerts (id INTEGER PRIMARY KEY NOT NULL, title TEXT NOT NULL, description TEXT NOT NULL, address TEXT NOT NULL, lat REAL NOT NULL, lng REAL NOT NULL);',
        [],
        /**Success
